...
export default function Header() {
  return (
    <div className="sticky top-[2rem] flex flex-wrap lg:gap-10 gap-2 justify-between items-center self-center px-5 lg:px-8 lg:py-5 py-3 text-sm rounded-lg border border-solid bg-black bg-opacity-20 backdrop-blur-sm border-sky-400 border-opacity-10 w-[90%] max-w-[1284px] max-lg:px-5 max-lg:max-w-full z-[999999]">
      <img
        loading="lazy"
